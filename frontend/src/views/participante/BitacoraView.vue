      ...
      <div class="sidebar">
        <div class="card formal-card sticky-sidebar shadow-sm">
          ...
          <div class="card-body formal-body">
            <div v-if="!isEventoActive" class="alert alert-warning mb-4" style="background-color: #fffbeb; color: #92400e; border-left: 4px solid #f59e0b; padding: 0.75rem; border-radius: 0.25rem; font-size: 0.875rem; font-weight: 600;">
              El evento no está activo. No se pueden subir ni modificar avances.
            </div>
              ...
              <div class="form-group mb-5">
                ...
                <div class="textarea-wrapper">
                  <textarea 
                    ...
                    rows="5" 
                    required
                    :disabled="!isEventoActive"
                  ></textarea>
                </div>
              </div>

              <button type="submit" class="btn btn-publish" :disabled="saving || !isEventoActive">
                ...
                <template v-else>
                  ...
                  <span>{{ !isEventoActive ? 'Bloqueado' : (isEditing ? 'Guardar Cambios' : 'Publicar Avance') }}</span>
                </template>
              </button>
              ...
              <div class="item-body card shadow-timeline">
                <div class="item-header">
                  ...
                  <div class="item-actions">
                    <button v-if="canDelete(a) && isEventoActive" @click="startEdit(a)" class="btn-action-tiny btn-edit-tiny" title="Editar">
                    ...
                    <button v-if="canDelete(a) && isEventoActive" @click="confirmDelete(a.id)" class="btn-action-tiny btn-delete-tiny" title="Eliminar">
...
async function fetchAvances() {
  try {
    ...
    isEventoActive.value = r.data.data.is_evento_active !== false // default true just in case
  } catch (e) {
    console.error(e)
  } finally {
    loading.value = false
